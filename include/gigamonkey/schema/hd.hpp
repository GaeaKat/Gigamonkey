...
namespace Gigamonkey::Bitcoin::hd {
    ...
    namespace bip32 {
        ...
        struct pubkey {
            ...
            static pubkey from_seed(entropy seed,type net);
        ...
        struct secret {
            ...
            static secret from_seed(entropy seed,type net);
    ...
    namespace bip39 {
        ...
        entropy read(cross<std::string> words);
        
        cross<std::string> write(entropy);
    ...
    namespace bip39 {
        inline const cross<std::string>& words() {
